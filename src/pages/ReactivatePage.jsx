...
const ReactivatePage = () => {
    ...
    const email = "daniel.pardo@gmail.com";
    ...
    return (
        <div>
            <form onSubmit={handleVerificationcode}>
                ...
                <p>
                    Hemos enviado un correo a tu cuenta {emailOculto}, introduce
                    el codigo de verificacion y la nueva contraseña a
                    continuacion para continuar
                </p>
                <label>
                    New Password:
                    <input
