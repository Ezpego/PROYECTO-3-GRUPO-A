...
export const TokenProvider = ({ children }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            console.log(
                "este es el token que habia almacenado el local",
                loggedUser
            );
            ...
            if (loggedUser) {
                ...
                try {
                    const response = await fetch(
                        ...
                        {
                            method: "GET",
                            headers: { authorization: `${loggedUser}` },
                        }
                    );
                    ...
                    const result = await response.json();
                    console.log("Datos usuarios", result);
                    setUserData(result);
                } catch (error) {
                    console.log("algo fue mal 2.0");
                }
                ...
                //         const result = await userDataResponse;
