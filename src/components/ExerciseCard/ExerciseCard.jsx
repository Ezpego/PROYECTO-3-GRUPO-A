...
const ExerciseCard = ({
    ...
    const [fillFavouriteButton, setFillFavouriteButton] =
        useState(favouriteUser);
    ...
    console.log("Quiero ver esto", typologyType);
    ...
    const exerciseObj = {
        ...
        photo: image_url,
        typology_name:
            typologyArray.find((typology) => Number(typology.id) === id)
                ?.name || "",
        muscle_group_name:
