...
return (
    ...
    <>
                ...
                {formErrors && formErrors.includes("Email") && <div className="error-message">{formErrors}</div>}
                </label>
                ...
                {formErrors && formErrors.includes("Password") && <div className="error-message">{formErrors}</div>}
                </label>
